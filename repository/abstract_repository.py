...
"""
штука, определяющая типы. Нужна, чтобы статическое определение типов работало хорошо

первый аргумент - имя переменной

второй - "ограниение сверху" по частичному порядку "класс является подклассом", то есть тип T - 
всевозможные подклассы класса Model

TypeVar, видимо, возвращает имя типа / класса..

Generic - абстрактный базовый класс для унив типов
"""
